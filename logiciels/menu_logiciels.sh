...
sous_menu_docker() {
    ...
    case $CHOIX in
        1) 
        logiciel="docker" 
        chmod +x logiciels/scripts/install_$logiciel.sh
        installer $logiciel && bash logiciels/scripts/install_$logiciel.sh && installer1 $logiciel
        ;;
        2) 
        logiciel="glpi"
        chmod +x logiciels/scripts/install_$logiciel.sh
        installer "GLPI (Gestion de parc )" && bash logiciels/scripts/install_$logiciel.sh && installer1 $logiciel
        ;;
        3) 
        logiciel="zabix"
        chmod +x logiciels/scripts/install_$logiciel.sh
        nstaller "Zabbix (Supervision)" && bash logiciels/scripts/install_$logiciel.sh && installer1 $logiciel
        ;;
        4) 
        logiciel="nagios"
        chmod +x logiciels/scripts/install_$logiciel.sh
        installer "Nagios (Supervision)" && bash logiciels/scripts/install_$logiciel.sh && installer1 $logiciel
        ;;
        5) 
        logiciel="xivo"
        chmod +x logiciels/scripts/install_$logiciel.sh
        installer "XiVO (VOIP)" && bash logiciels/scripts/install_$logiciel.sh && installer1 $logiciel
        ;;
        6)
        return
        ;;
