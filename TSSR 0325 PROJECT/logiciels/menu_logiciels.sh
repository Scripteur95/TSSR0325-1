...
sous_menu_docker() {
    ...
    case $CHOIX in
        1) logiciel="docker" && installer $logiciel && bash /home/sam/script/TSSR/logiciels/scripts/install_$logiciel.sh && installer1 $logiciel ;;
        ...
        3) logiciel="zabix" && installer "Zabbix (Supervision)" && bash /home/sam/script/TSSR/logiciels/scripts/install_$logiciel.sh && installer1 $logiciel ;;
...
main(){
    chmod +x /home/sam/script/TSSR/logiciels/scripts/install_docker.sh
    menu_principal
}
