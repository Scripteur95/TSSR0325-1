...
menu_admin(){
    ...
    while true; do
        ...
        case "$choice" in
            ...
            chmod +x /home/sam/script/TSSR/administration/scripts/createuser.sh
            ...
            bash /home/sam/script/TSSR/administration/scripts/createuser.sh || result=$?
            ;;
            2)
            chmod +x /home/sam/script/TSSR/administration/scripts/deluser.sh
            bash /home/sam/script/TSSR/administration/scripts/deluser.sh || result=$?
            ;;
            3)
            chmod +x /home/sam/script/TSSR/administration/scripts/changeIP.sh
            bash /home/sam/script/TSSR/administration/scripts/changeIP.sh || result=$?
            ;;
            4)
            chmod +x /home/sam/script/TSSR/administration/scripts/confsudo.sh
            bash /home/sam/script/TSSR/administration/scripts/confsudo.sh || result=$?
            ;;
            5)
            chmod +x /home/sam/script/TSSR/administration/scripts/changedroits.sh
            bash /home/sam/script/TSSR/administration/scripts/changedroits.sh || result=$?
            ;;
            6)
            chmod +x /home/sam/script/TSSR/administration/scripts/confssh.sh
            bash /home/sam/script/TSSR/administration/scripts/confssh.sh || result=$?
            ;;
            7)
            chmod +x /home/sam/script/TSSR/administration/scripts/confDNS.sh
            bash /home/sam/script/TSSR/administration/scripts/confDNS.sh || result=$?
            ;;
            8)
            chmod +x /home/sam/script/TSSR/administration/scripts/confDHCP.sh
            bash /home/sam/script/TSSR/administration/scripts/confDHCP.sh || result=$?
            ;;
            9)
            chmod +x /home/sam/script/TSSR/administration/scripts/routing.sh
            bash /home/sam/script/TSSR/administration/scripts/routing.sh || result=$?
            ;;
            10)
            chmod +x /home/sam/script/TSSR/administration/scripts/FTPconfig.sh
            bash /home/sam/script/TSSR/administration/scripts/FTPconfig.sh || result=$?
            ;;
            11)
