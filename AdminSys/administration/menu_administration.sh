...
menu_admin(){
    ...
    while true; do
        ...
        case "$choice" in
            ...
            chmod +x $HOME/TSSR0325/AdminSys/administration/scripts/createuser.sh
            ...
            bash $HOME/TSSR0325/AdminSys/administration/scripts/createuser.sh || result=$?
            ;;
            2)
            chmod +x $HOME/TSSR0325/AdminSys/administration/scripts/deluser.sh
            bash $HOME/TSSR0325/AdminSys/administration/scripts/deluser.sh || result=$?
            ;;
            3)
            chmod +x $HOME/TSSR0325/AdminSys/administration/scripts/changeIP.sh
            bash $HOME/TSSR0325/AdminSys/administration/scripts/changeIP.sh || result=$?
            ;;
            4)
            chmod +x $HOME/TSSR0325/AdminSys/administration/scripts/confsudo.sh
            bash $HOME/TSSR0325/AdminSys/administration/scripts/confsudo.sh || result=$?
            ;;
            5)
            chmod +x $HOME/TSSR0325/AdminSys/administration/scripts/changedroits.sh
            bash $HOME/TSSR0325/AdminSys/administration/scripts/changedroits.sh || result=$?
            ;;
            6)
            chmod +x $HOME/TSSR0325/AdminSys/administration/scripts/confssh.sh
            bash $HOME/TSSR0325/AdminSys/administration/scripts/confssh.sh || result=$?
            ;;
            7)
            chmod +x $HOME/TSSR0325/AdminSys/administration/scripts/confDNS.sh
            bash $HOME/TSSR0325/AdminSys/administration/scripts/confDNS.sh || result=$?
            ;;
            8)
            chmod +x $HOME/TSSR0325/AdminSys/administration/scripts/confDHCP.sh
            bash $HOME/TSSR0325/AdminSys/administration/scripts/confDHCP.sh || result=$?
            ;;
            9)
            chmod +x $HOME/TSSR0325/AdminSys/administration/scripts/routing.sh
            bash $HOME/TSSR0325/AdminSys/administration/scripts/routing.sh || result=$?
            ;;
            10)
            chmod +x $HOME/TSSR0325/AdminSys/administration/scripts/FTPconfig.sh
            bash $HOME/TSSR0325/AdminSys/administration/scripts/FTPconfig.sh || result=$?
            ;;
            11)
